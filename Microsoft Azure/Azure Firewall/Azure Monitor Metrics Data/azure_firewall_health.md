...
The API is used to retrieve Azure Firewall <b>FirewallHealth</b> metric data from Azure API Server (https://management.azure.com/). The metric indicates the overall health of this firewall.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: FirewallHealth
* <b>NetBrain Display Name</b>: Firewall Health
* <b>Unit</b>: Percent
