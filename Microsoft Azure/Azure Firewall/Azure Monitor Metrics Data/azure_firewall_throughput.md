...
The API is used to retrieve Azure Firewall <b>Throughput</b> metric data from Azure API Server (https://management.azure.com/). The metric is about throughput processed by this firewal.
