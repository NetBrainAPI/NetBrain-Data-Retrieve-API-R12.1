...
The API is used to retrieve Azure Firewall <b>ApplicationRuleHit</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of times Application rules were hit.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ApplicationRuleHit
* <b>NetBrain Display Name</b>: Application Rule Hit
* <b>Unit</b>: Count
