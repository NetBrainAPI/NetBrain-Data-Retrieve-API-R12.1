...
The API is used to retrieve Azure Firewall <b>DataProcessed</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total amount of data processed by this firewall.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: DataProcessed
* <b>NetBrain Display Name</b>: Data Processed
* <b>Unit</b>: Bytes
