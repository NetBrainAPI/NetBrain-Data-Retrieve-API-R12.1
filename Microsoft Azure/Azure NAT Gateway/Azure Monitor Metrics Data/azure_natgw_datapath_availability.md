...
The API is used to retrieve Azure NAT Gateway <b>DatapathAvailability</b> metric data from Azure API Server (https://management.azure.com/). The metric is about NAT Gateway datapath availability.
