...
The API is used to retrieve Azure NAT Gateway <b>PacketDropCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of dropped packets.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: PacketDropCount 
* <b>NetBrain Display Name</b>: Packet Drop Count
* <b>Unit</b>: Count
