...
The API is used to retrieve Azure NAT Gateway <b>SNATConnectionCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total concurrent active connections.
