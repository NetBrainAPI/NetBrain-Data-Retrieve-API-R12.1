...
The API is used to retrieve Azure Firewall <b>HealthyHostCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of healthy backend hosts.
