...
The API is used to retrieve Azure Firewall <b>ComputeUnits</b> metric data from Azure API Server (https://management.azure.com/). The metric is about compute units consumed.
