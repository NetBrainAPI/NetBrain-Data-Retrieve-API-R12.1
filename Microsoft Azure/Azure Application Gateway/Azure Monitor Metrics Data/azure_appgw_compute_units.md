...
The API is used to retrieve Azure Application Gateway <b>ComputeUnits</b> metric data from Azure API Server (https://management.azure.com/). The metric is about compute units consumed.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ComputeUnits   
* <b>NetBrain Display Name</b>: Compute Units
* <b>Unit</b>: Counts
