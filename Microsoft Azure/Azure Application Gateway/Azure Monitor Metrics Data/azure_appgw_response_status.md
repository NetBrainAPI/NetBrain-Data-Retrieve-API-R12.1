...
The API is used to retrieve Azure Application Gateway <b>ResponseStatus</b> metric data from Azure API Server (https://management.azure.com/). The metric is about Http response status returned by Application Gateway.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ResponseStatus  
* <b>NetBrain Display Name</b>: Response Status
* <b>Unit</b>: Count
