...
The API is used to retrieve Azure Firewall <b>ResponseStatus</b> metric data from Azure API Server (https://management.azure.com/). The metric is about Http response status returned by Application Gateway.
