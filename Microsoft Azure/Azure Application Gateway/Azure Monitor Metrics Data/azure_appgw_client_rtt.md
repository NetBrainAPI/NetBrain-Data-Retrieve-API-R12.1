...
The API is used to retrieve Azure Application Gateway <b>ClientRtt</b> metric data from Azure API Server (https://management.azure.com/). The metric is about round trip time between clients and Application Gateway.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ClientRtt   
* <b>NetBrain Display Name</b>: Client Rtt
