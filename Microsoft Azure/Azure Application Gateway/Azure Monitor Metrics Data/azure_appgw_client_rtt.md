...
The API is used to retrieve Azure Firewall <b>ClientRtt</b> metric data from Azure API Server (https://management.azure.com/). The metric is about round trip time between clients and Application Gateway.
