...
The API is used to retrieve Azure Firewall <b>FailedRequests</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of failed requests that Application Gateway has served.
