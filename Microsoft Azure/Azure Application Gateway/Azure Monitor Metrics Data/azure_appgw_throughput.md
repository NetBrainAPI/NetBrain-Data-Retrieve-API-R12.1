...
The API is used to retrieve Azure Firewall <b>Throughput</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of bytes per second the Application Gateway has served.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Throughput
* <b>NetBrain Display Name</b>: Throughput
