...
The API is used to retrieve Azure Firewall <b>AzwafBotProtection</b> metric data from Azure API Server (https://management.azure.com/). The metric is about matched Bot Rules.
