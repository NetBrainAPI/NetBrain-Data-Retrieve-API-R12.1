...
The API is used to retrieve Azure Application Gateway <b>AzwafBotProtection</b> metric data from Azure API Server (https://management.azure.com/). The metric is about matched Bot Rules.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: AzwafBotProtection
* <b>NetBrain Display Name</b>: Azwaf Bot Protection
* <b>Unit</b>: Count
...
* <b>Auto Adjust Timegrain</b>: When set to false, invalid filter parameter values will be ignored. When set to true, an error is returned for invalid filter parameters. Defaults to <b>false</b>.
