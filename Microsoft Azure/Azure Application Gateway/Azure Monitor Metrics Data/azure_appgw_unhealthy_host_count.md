...
The API is used to retrieve Azure Firewall <b>UnhealthyHostCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of unhealthy backend hosts.
