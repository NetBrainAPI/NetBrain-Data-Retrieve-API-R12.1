...
The API is used to retrieve Azure Application Gateway <b>BackendResponseStatus</b> metric data from Azure API Server (https://management.azure.com/). The metric is about the number of HTTP response codes generated by the backend members.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: BackendResponseStatus
* <b>NetBrain Display Name</b>: Backend Response Status
* <b>Unit</b>: Count
