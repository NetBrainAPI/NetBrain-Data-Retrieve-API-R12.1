...
The API is used to retrieve Azure Firewall <b>BackendResponseStatus</b> metric data from Azure API Server (https://management.azure.com/). The metric is about the number of HTTP response codes generated by the backend members.
