...
The API is used to retrieve Azure Application Gateway <b>CpuUtilization</b> metric data from Azure API Server (https://management.azure.com/). The metric is about current CPU utilization of the Application Gateway.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: CpuUtilization    
* <b>NetBrain Display Name</b>: Cpu Utilization
* <b>Unit</b>: Percent
