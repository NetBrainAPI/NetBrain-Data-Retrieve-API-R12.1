...
The API is used to retrieve Azure Virtual Machine <b>VM Uncached Bandwidth Consumed Percentage</b> metric data from Azure API Server (https://management.azure.com/). The metric is about percentage of uncached disk bandwidth consumed by the VM..

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: VM Uncached Bandwidth Consumed Percentage
* <b>NetBrain Display Name</b>: VM Uncached Bandwidth Consumed Percentage
* <b>Unit</b>: Percent
