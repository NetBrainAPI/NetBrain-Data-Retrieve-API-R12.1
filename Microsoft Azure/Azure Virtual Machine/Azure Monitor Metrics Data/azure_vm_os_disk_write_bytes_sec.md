...
The API is used to retrieve Azure Virtual Machine <b>OS Disk Write Bytes/sec</b> metric data from Azure API Server (https://management.azure.com/). The metric is about Bytes/Sec written to a single disk during monitoring period for OS disk.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: OS Disk Write Bytes/sec
* <b>NetBrain Display Name</b>: OS Disk Write Bytes/Sec
