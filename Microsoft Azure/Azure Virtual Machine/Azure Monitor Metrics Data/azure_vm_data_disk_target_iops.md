...
The API is used to retrieve Azure Virtual Machine <b>Data Disk Target IOPS</b> metric data from Azure API Server (https://management.azure.com/). The metric is about baseline IOPS Data Disk can achieve without bursting.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Data Disk Target IOPS
* <b>NetBrain Display Name</b>: Data Disk Target IOPS
* <b>Unit</b>: Count
