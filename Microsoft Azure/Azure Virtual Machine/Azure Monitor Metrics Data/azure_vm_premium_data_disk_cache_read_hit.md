...
The API is used to retrieve Azure Virtual Machine <b>Premium Data Disk Cache Read Hit</b> metric data from Azure API Server (https://management.azure.com/). The metric is about premium data disk cache read hit.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Premium Data Disk Cache Read Hit
* <b>NetBrain Display Name</b>: Premium Data Disk Cache Read Hit
* <b>Unit</b>: Percent
