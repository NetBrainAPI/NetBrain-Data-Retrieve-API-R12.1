...
The API is used to retrieve Azure Virtual Machine <b>OS Disk Used Burst BPS Credits Percentage</b> metric data from Azure API Server (https://management.azure.com/). The metric is about percentage of OS Disk burst bandwidth credits used so far.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: OS Disk Used Burst BPS Credits Percentage
* <b>NetBrain Display Name</b>: OS Disk Used Burst BPS Credits Percentage
* <b>Unit</b>: Percent
