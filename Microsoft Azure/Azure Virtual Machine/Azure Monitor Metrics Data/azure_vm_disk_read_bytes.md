...
The API is used to retrieve Azure Virtual Machine <b>Disk Read Bytes</b> metric data from Azure API Server (https://management.azure.com/). The metric is about bytes read from disk during monitoring period.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Disk Read Bytes
* <b>NetBrain Display Name</b>: Disk Read Bytes
* <b>Unit</b>: Bytes
