...
The API is used to retrieve Azure Virtual Machine <b>OS Disk Target IOPS</b> metric data from Azure API Server (https://management.azure.com/). The metric is about baseline IOPS OS Disk can achieve without bursting.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: OS Disk Target IOPS
* <b>NetBrain Display Name</b>: OS Disk Target IOPS
* <b>Unit</b>: Count
