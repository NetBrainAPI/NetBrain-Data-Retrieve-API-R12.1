...
The API is used to retrieve Azure Virtual Machine <b>Data Disk Bandwidth Consumed Percentage</b> metric data from Azure API Server (https://management.azure.com/). The metric is about about percentage of data disk bandwidth consumed per minute.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Data Disk Bandwidth Consumed Percentage
* <b>NetBrain Display Name</b>: Data Disk Bandwidth Consumed Percentage
* <b>Unit</b>: Percent
