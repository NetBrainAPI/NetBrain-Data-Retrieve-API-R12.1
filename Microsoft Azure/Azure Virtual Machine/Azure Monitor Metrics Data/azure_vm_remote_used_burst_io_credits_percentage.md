...
The API is used to retrieve Azure Virtual Machine <b>VM Remote Used Burst IO Credits Percentage</b> metric data from Azure API Server (https://management.azure.com/). The metric is about percentage of Uncached Burst IO Credits used by the VM.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: VM Remote Used Burst IO Credits Percentage
* <b>NetBrain Display Name</b>: VM Remote Used Burst IO Credits Percentage
* <b>Unit</b>: Percent
