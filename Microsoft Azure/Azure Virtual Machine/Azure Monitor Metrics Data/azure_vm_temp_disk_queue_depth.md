...
The API is used to retrieve Azure Virtual Machine <b>Temp Disk Queue Depth</b> metric data from Azure API Server (https://management.azure.com/). The metric is about temp disk queue depth(or queue length).

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Temp Disk Queue Depth 
* <b>NetBrain Display Name</b>: Temp Disk Queue Depth 
* <b>Unit</b>: Count
