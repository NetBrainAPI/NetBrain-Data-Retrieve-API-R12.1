...
The API is used to retrieve Azure Virtual Machine <b>CPU Credits Remaining</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total number of credits available to burst..

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: CPU Credits Remaining
* <b>NetBrain Display Name</b>: CPU Credits Remaining
* <b>Unit</b>: Count
