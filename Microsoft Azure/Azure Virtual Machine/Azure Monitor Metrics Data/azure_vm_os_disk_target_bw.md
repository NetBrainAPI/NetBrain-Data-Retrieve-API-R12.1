...
The API is used to retrieve Azure Virtual Machine <b>OS Disk Target Bandwidth</b> metric data from Azure API Server (https://management.azure.com/). The metric is about baseline bytes per second throughput OS Disk can achieve without bursting.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: OS Disk Target Bandwidth
* <b>NetBrain Display Name</b>: OS Disk Target Bandwidth
* <b>Unit</b>: Count
