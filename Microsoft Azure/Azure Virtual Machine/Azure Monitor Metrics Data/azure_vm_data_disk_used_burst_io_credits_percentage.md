...
The API is used to retrieve Azure Virtual Machine <b>Data Disk Used Burst IO Credits Percentage</b> metric data from Azure API Server (https://management.azure.com/). The metric is about percentage of Data Disk burst I/O credits used so far.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Data Disk Used Burst IO Credits Percentage
* <b>NetBrain Display Name</b>: Data Disk Used Burst IO Credits Percentage
* <b>Unit</b>: Percent
