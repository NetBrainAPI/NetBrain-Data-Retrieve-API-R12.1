...
The API is used to retrieve Azure Virtual Machine <b>Percentage CPU</b> metric data from Azure API Server (https://management.azure.com/). The metric is about the percentage of allocated compute units that are currently in use by the Virtual Machine(s).

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Percentage CPU
* <b>NetBrain Display Name</b>: Percentage CPU
* <b>Unit</b>: Percent
