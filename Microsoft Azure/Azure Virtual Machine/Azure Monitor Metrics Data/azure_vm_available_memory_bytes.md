...
The API is used to retrieve Azure Virtual Machine <b>Available Memory Bytes</b> metric data from Azure API Server (https://management.azure.com/). The metric is about amount of physical memory, in bytes, immediately available for allocation to a process or for system use in the Virtual Machine.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Available Memory Bytes
* <b>NetBrain Display Name</b>: Available Memory Bytes
* <b>Unit</b>: Bytes
