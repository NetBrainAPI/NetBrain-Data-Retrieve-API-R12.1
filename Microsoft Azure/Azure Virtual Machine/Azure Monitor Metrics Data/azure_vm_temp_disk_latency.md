...
The API is used to retrieve Azure Virtual Machine <b>Temp Disk Latency</b> metric data from Azure API Server (https://management.azure.com/). The metric is about average time to complete each IO during monitoring period for Temp Disk.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Temp Disk Latency
* <b>NetBrain Display Name</b>: Temp Disk Latency
