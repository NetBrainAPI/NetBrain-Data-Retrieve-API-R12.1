...
The API is used to retrieve Azure Private Link Service <b>PLSBytesIn</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total number of bytes in.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: PLSBytesIn 
* <b>NetBrain Display Name</b>: PLS Bytes In
* <b>Unit</b>: Count
