...
The API is used to retrieve Azure ExpressRoute Gateway <b>ExpressRouteGatewayFrequencyOfRoutesChanged</b> metric data from Azure API Server (https://management.azure.com/). The metric is about frequency of routes change in ExpressRoute Gateway.
...
* <b>NetBrain Display Name</b>: Frequency Of Routes Changed
* <b>Unit</b>: Count
