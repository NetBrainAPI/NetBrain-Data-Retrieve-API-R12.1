...
The API is used to retrieve Azure ExpressRoute Gateway <b>ExpressRouteGatewayCpuUtilization</b> metric data from Azure API Server (https://management.azure.com/). The metric is about CPU Utilization of the ExpressRoute Gateway.
