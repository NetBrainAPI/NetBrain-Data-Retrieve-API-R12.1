...
The API is used to retrieve Azure ExpressRoute Gateway <b>ExpressRouteGatewayBitsPerSecond</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total Bits received on ExpressRoute Gateway per second.
...
* <b>NetBrain Display Name</b>: Bits Per Second
