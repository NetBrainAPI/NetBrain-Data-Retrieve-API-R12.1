...
The API is used to retrieve Azure Firewall <b>ExpressRouteGatewayActiveFlows </b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of active flows on ExpressRoute Gateway.
...
* <b>NetBrain Display Name</b>: Active Flows
* <b>Unit</b>: Count
