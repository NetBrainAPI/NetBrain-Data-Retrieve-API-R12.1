...
The API is used to retrieve Azure ExpressRoute Gateway <b>ExpressRouteGatewayNumberOfVmInVnet</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of VMs in the Virtual Network.
...
* <b>NetBrain Display Name</b>: Number Of Vm In Vnet
* <b>Unit</b>: Count
