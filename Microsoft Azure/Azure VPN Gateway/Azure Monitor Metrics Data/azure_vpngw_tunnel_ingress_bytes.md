...
The API is used to retrieve Azure VPN Gateway <b>TunnelIngressBytes</b> metric data from Azure API Server (https://management.azure.com/). The metric is about incoming bytes of a tunnel.
