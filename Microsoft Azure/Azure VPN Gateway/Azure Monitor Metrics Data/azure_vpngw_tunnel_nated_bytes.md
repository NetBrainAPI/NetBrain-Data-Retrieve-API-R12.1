...
The API is used to retrieve Azure VPN Gateway <b>TunnelNatedBytes</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of bytes that were NATed on a tunnel by a NAT rule.
