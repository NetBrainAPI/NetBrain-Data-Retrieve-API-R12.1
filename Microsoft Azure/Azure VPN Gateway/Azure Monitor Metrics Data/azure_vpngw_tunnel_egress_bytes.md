...
The API is used to retrieve Azure VPN Gateway <b>TunnelEgressBytes</b> metric data from Azure API Server (https://management.azure.com/). The metric is about outgoing bytes of a tunnel. The Unit is Bytes.
