...
The API is used to retrieve Azure VPN Gateway <b>InboundFlowsCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of 5-tuple flows entering into a VPN gateway.
