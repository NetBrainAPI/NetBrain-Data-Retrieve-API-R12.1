...
The API is used to retrieve Azure VPN Gateway <b>TunnelIngressPacketDropCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of incoming packets dropped by tunnel.
