...
The API is used to retrieve Azure VPN Gateway <b>AverageBandwidth</b> metric data from Azure API Server (https://management.azure.com/). The metric is about site-to-site bandwidth of a gateway in bytes per second.
