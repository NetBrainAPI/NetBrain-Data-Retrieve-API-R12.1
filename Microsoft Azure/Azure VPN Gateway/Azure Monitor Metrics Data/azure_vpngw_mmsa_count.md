...
The API is used to retrieve Azure VPN Gateway <b>MmsaCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about MMSA count.
