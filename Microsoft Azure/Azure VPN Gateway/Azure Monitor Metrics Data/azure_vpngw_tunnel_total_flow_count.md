...
The API is used to retrieve Azure VPN Gateway <b>TunnelTotalFlowCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total flow count on a tunnel.
