...
The API is used to retrieve Azure VPN Gateway <b>TunnelEgressPacketDropTSMismatch</b> metric data from Azure API Server (https://management.azure.com/). The metric is about outgoing packet drop count from traffic selector mismatch of a tunnel.
