...
The API is used to retrieve Azure VPN Gateway <b>BgpRoutesAdvertised</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of Bgp Routes Advertised through tunnel.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: BgpRoutesAdvertised 
* <b>NetBrain Display Name</b>: Bgp Routes Advertised
* <b>Unit</b>: Count
