...
The API is used to retrieve Azure VPN Gateway <b>TunnelNatFlowCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of NAT flows on a tunnel by flow type and NAT rule.
