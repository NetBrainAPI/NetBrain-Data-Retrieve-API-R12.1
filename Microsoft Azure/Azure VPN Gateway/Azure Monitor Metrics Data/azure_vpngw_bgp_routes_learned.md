...
The API is used to retrieve Azure VPN Gateway <b>BgpRoutesLearned</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of Bgp Routes Learned through tunnel.
