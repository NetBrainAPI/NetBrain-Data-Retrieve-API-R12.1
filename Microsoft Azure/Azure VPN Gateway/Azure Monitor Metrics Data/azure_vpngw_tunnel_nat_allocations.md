...
The API is used to retrieve Azure VPN Gateway <b>TunnelNatAllocations</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of allocations for a NAT rule on a tunnel.
