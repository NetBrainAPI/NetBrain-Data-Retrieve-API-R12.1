...
The API is used to retrieve Azure VPN Gateway <b>TunnelEgressPackets</b> metric data from Azure API Server (https://management.azure.com/). The metric is about outgoing packet count of a tunnel.
