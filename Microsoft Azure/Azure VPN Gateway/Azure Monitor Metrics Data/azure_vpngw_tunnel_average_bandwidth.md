...
The API is used to retrieve Azure VPN Gateway <b>TunnelAverageBandwidth</b> metric data from Azure API Server (https://management.azure.com/). The metric is about average bandwidth of a tunnel in bytes per second.
