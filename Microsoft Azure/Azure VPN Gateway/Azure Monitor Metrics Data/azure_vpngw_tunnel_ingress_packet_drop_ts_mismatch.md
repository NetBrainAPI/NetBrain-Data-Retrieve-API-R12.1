...
The API is used to retrieve Azure VPN Gateway <b>TunnelIngressPacketDropTSMismatch</b> metric data from Azure API Server (https://management.azure.com/). The metric is about incoming packet drop count from traffic selector mismatch of a tunnel.
