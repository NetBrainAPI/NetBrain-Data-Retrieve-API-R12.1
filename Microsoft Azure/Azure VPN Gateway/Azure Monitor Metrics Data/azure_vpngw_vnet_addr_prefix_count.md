...
The API is used to retrieve Azure VPN Gateway <b>VnetAddressPrefixCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of Vnet address prefixes behind gateway.
