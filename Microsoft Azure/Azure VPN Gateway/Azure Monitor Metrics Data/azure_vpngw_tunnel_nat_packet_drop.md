...
The API is used to retrieve Azure VPN Gateway <b>TunnelNatPacketDrop</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of NATed packets on a tunnel that dropped by drop type and NAT rule.
