...
The API is used to retrieve Azure VPN Gateway <b>TunnelReverseNatedBytes</b> metric data from Azure API Server (https://management.azure.com/). The metric is about umber of bytes that were reverse NATed on a tunnel by a NAT rule.
