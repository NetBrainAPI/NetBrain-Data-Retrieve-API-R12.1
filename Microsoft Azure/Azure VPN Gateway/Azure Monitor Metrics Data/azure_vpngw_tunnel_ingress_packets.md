...
The API is used to retrieve Azure VPN Gateway <b>TunnelIngressPackets</b> metric data from Azure API Server (https://management.azure.com/). The metric is about incoming packet count of a tunnel.
