...
The API is used to retrieve Azure VPN Gateway <b>TunnelEgressPacketDropCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of outgoing packets dropped by tunnel.
