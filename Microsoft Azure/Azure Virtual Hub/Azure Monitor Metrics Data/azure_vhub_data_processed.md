...
The API is used to retrieve Azure Virtual Hub <b>VirtualHubDataProcessed</b> metric data from Azure API Server (https://management.azure.com/). The metric is about data on how much traffic traverses the virtual hub router in a given time period.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: VirtualHubDataProcessed 
* <b>NetBrain Display Name</b>: Virtual Hub Data Processed
* <b>Unit</b>: Bytes
