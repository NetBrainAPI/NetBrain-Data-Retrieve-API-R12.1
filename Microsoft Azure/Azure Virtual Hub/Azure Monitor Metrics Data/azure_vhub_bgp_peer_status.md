...
The API is used to retrieve Azure Virtual Hub <b>BgpPeerStatus</b> metric data from Azure API Server (https://management.azure.com/). The metric is about 1 - Connected, 0 - Not connected.
