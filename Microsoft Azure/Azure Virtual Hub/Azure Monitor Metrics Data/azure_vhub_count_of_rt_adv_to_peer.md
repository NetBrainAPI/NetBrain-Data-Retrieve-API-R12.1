...
The API is used to retrieve Azure Virtual Hub <b>CountOfRoutesAdvertisedToPeer</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total number of routes advertised to peer.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: CountOfRoutesAdvertisedToPeer 
* <b>NetBrain Display Name</b>: Count Of Routes Advertised To Peer
* <b>Unit</b>: Count
