...
The API is used to retrieve Load Balancer <b>GlobalBackendAvailability</b> metric data from Azure API Server (https://management.azure.com/). The metric is about Azure Cross-region Load Balancer backend health and status per time duration.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: GlobalBackendAvailability 
* <b>NetBrain Display Name</b>: Global Backend Availability
* <b>Unit</b>: Count
...
* <b>Metrics Details</b>: https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-metrics/microsoft-network-loadbalancers-metrics
