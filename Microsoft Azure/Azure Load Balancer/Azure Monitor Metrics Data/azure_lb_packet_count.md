...
The API is used to retrieve Load Balancer <b>PacketCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total number of Packets transmitted within time period.
