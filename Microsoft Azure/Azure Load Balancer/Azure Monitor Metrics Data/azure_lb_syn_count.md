...
The API is used to retrieve Load Balancer <b>SYNCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total number of SYN Packets transmitted within time period.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: SYNCount  
* <b>NetBrain Display Name</b>: SYN Count
* <b>Unit</b>: Count
