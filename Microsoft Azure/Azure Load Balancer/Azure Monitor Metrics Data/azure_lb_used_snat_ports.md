...
The API is used to retrieve Load Balancer <b>UsedSnatPorts</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total number of SNAT ports used within time period.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: UsedSnatPorts  
* <b>NetBrain Display Name</b>: Used Snat Ports 
* <b>Unit</b>: Count
