...
The API is used to retrieve Load Balancer <b>ByteCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total number of Bytes transmitted within time period.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ByteCount 
* <b>NetBrain Display Name</b>: Byte Count
* <b>Unit</b>: Bytes
