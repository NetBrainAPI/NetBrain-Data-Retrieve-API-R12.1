...
The API is used to retrieve Load Balancer <b>DipAvailability</b> metric data from Azure API Server (https://management.azure.com/). The metric is about average Load Balancer health probe status per time duration.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: DipAvailability 
* <b>NetBrain Display Name</b>: Dip Availability
* <b>Unit</b>: Count
