...
The API is used to retrieve Azure Virtual Network Gateway <b>TunnelReverseNatedBytes</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of bytes that were reverse NATed on a tunnel by a NAT rule.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TunnelReverseNatedBytes
* <b>NetBrain Display Name</b>: Tunnel Reverse Nated Bytes
* <b>Unit</b>: Bytes
