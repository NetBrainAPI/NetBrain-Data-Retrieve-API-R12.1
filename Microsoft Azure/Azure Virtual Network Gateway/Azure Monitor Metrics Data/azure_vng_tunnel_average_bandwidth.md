...
The API is used to retrieve Azure Virtual Network Gateway <b>TunnelAverageBandwidth</b> metric data from Azure API Server (https://management.azure.com/). The metric is about average bandwidth of a tunnel in bytes per second.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TunnelAverageBandwidth
* <b>NetBrain Display Name</b>: Tunnel Average Bandwidth
