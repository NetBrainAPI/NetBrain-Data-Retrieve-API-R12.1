...
The API is used to retrieve Azure Virtual Network Gateway <b>AverageBandwidth</b> metric data from Azure API Server (https://management.azure.com/). The metric is about site-to-site bandwidth of a gateway in bytes per second.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: AverageBandwidth
* <b>NetBrain Display Name</b>: Average Bandwidth
