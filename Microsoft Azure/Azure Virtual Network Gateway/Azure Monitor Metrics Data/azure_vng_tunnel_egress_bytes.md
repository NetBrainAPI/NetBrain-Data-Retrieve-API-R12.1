...
The API is used to retrieve Azure Virtual Network Gateway <b>TunnelEgressBytes</b> metric data from Azure API Server (https://management.azure.com/). The metric is about outgoing bytes of a tunnel.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TunnelEgressBytes
* <b>NetBrain Display Name</b>: Tunnel Egress Bytes
* <b>Unit</b>: Bytes
