...
The API is used to retrieve Azure Virtual Network Gateway <b>ScalableExpressRouteGatewayCpuUtilization</b> metric data from Azure API Server (https://management.azure.com/). The metric is about CPU utilization of the ExpressRoute Gateway.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ScalableExpressRouteGatewayCpuUtilization
* <b>NetBrain Display Name</b>: Scalable ExpressRoute Gateway Cpu Utilization
* <b>Unit</b>: Percent
