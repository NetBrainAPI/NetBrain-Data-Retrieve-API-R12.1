...
The API is used to retrieve Azure Virtual Network Gateway <b>MmsaCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about MMSA count.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: MmsaCount
* <b>NetBrain Display Name</b>: Mmsa Count
* <b>Unit</b>: Count
