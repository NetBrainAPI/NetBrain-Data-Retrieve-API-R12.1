...
The API is used to retrieve Azure Virtual Network Gateway <b>BgpPeerStatus</b> metric data from Azure API Server (https://management.azure.com/). The metric is about status of BGP peer.
