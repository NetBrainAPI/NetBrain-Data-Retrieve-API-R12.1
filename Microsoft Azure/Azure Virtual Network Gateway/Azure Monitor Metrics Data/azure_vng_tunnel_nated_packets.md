...
The API is used to retrieve Azure Virtual Network Gateway <b>TunnelNatedPackets</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of packets that were NATed on a tunnel by a NAT rule.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TunnelNatedPackets
* <b>NetBrain Display Name</b>: Tunnel Nated Packets
* <b>Unit</b>: Count
