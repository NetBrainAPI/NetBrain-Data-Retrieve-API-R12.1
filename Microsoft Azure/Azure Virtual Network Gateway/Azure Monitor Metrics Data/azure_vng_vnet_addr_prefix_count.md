...
The API is used to retrieve Azure Virtual Network Gateway <b>VnetAddressPrefixCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of Vnet address prefixes behind gateway.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: VnetAddressPrefixCount
* <b>NetBrain Display Name</b>: Vnet Address Prefix Count
* <b>Unit</b>: Count
