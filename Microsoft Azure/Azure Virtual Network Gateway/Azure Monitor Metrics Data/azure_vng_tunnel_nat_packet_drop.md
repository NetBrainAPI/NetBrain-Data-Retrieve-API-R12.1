...
The API is used to retrieve Azure Virtual Network Gateway <b>TunnelNatPacketDrop</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of NATed packets on a tunnel that dropped by drop type and NAT rule.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TunnelNatPacketDrop
* <b>NetBrain Display Name</b>: Tunnel Nat Packet Drop
* <b>Unit</b>: Count
