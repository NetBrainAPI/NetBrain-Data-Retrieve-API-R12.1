...
The API is used to retrieve Azure Virtual Network Gateway <b>ExpressRouteGatewayPacketsPerSecond</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total Packets received on ExpressRoute Gateway per second.
...
* <b>NetBrain Display Name</b>: ExpressRoute Gateway Packets Per Second
