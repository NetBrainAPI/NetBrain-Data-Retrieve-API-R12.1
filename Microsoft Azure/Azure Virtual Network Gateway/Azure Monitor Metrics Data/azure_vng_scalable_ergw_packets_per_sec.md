...
The API is used to retrieve Azure Virtual Network Gateway <b>ScalableExpressRouteGatewayPacketsPerSecond</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total packets received on ExpressRoute Gateway per second.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ScalableExpressRouteGatewayPacketsPerSecond
* <b>NetBrain Display Name</b>: Scalable ExpressRoute Gateway Packets Per Second
