...
The API is used to retrieve Azure Virtual Network Gateway <b>ExpressRouteGatewayMaxFlowsCreationRate</b> metric data from Azure API Server (https://management.azure.com/). The metric is about maximum number of flows created per second on ExpressRoute Gateway.
...
* <b>NetBrain Display Name</b>: ExpressRoute Gateway Max Flows Creation Rate
