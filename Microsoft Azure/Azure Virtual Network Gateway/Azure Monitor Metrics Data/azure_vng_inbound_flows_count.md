...
The API is used to retrieve Azure Virtual Network Gateway <b>InboundFlowsCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about number of 5-tuple flows entering into a VPN gateway.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: InboundFlowsCount
* <b>NetBrain Display Name</b>: Inbound Flows Count
* <b>Unit</b>: Count
