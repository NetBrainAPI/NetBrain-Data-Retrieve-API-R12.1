...
The API is used to retrieve Azure Virtual Network Gateway <b>ExpressRouteGatewayFrequencyOfRoutesChanged</b> metric data from Azure API Server (https://management.azure.com/). The metric is about frequency of routes change in ExpressRoute Gateway.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ExpressRouteGatewayFrequencyOfRoutesChanged
* <b>NetBrain Display Name</b>: ExpressRoute Gateway Frequency Of Routes Changed
* <b>Unit</b>: Count
