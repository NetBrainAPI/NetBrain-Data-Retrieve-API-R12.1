...
The API is used to retrieve Azure Virtual Network Gateway <b>BgpRoutesLearned</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of Bgp Routes Learned through tunnel.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: BgpRoutesLearned
* <b>NetBrain Display Name</b>: Bgp Routes Learned
* <b>Unit</b>: Count
