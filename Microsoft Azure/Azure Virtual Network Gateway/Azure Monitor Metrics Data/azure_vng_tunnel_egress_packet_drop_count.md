...
The API is used to retrieve Azure Virtual Network Gateway <b>TunnelEgressPacketDropCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of outgoing packets dropped by tunnel.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TunnelEgressPacketDropCount
* <b>NetBrain Display Name</b>: Tunnel Egress Packet Drop Count
* <b>Unit</b>: Count
