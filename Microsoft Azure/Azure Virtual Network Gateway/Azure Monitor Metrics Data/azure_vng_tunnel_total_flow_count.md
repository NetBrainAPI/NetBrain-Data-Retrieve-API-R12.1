...
The API is used to retrieve Azure Virtual Network Gateway <b>TunnelTotalFlowCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about total flow count on a tunnel.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TunnelTotalFlowCount
* <b>NetBrain Display Name</b>: Tunnel Total Flow Count
* <b>Unit</b>: Count
