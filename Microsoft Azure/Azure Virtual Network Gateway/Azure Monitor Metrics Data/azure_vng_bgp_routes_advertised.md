...
The API is used to retrieve Azure Virtual Network Gateway <b>BgpRoutesAdvertised</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of Bgp Routes Advertised through tunnel.
