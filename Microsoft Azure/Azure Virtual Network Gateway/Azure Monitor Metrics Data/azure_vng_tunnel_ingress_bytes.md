...
The API is used to retrieve Azure Virtual Network Gateway <b>TunnelIngressBytes</b> metric data from Azure API Server (https://management.azure.com/). The metric is about incoming bytes of a tunnel.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TunnelIngressBytes
* <b>NetBrain Display Name</b>: Tunnel Ingress Bytes
* <b>Unit</b>: Bytes
