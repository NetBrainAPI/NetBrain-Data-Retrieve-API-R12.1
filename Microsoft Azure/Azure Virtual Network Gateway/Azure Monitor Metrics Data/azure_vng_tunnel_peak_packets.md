...
The API is used to retrieve Azure Virtual Network Gateway <b>TunnelPeakPackets</b> metric data from Azure API Server (https://management.azure.com/). The metric is about tunnel peak packets per second.
