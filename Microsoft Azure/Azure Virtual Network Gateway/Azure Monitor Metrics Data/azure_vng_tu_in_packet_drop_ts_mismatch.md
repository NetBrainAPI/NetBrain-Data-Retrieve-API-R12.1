...
The API is used to retrieve Azure Virtual Network Gateway <b>TunnelIngressPacketDropTSMismatch</b> metric data from Azure API Server (https://management.azure.com/). The metric is about incoming packet drop count from traffic selector mismatch of a tunnel.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TunnelIngressPacketDropTSMismatch
* <b>NetBrain Display Name</b>: Tunnel Ingress Packet Drop TS Mismatch
* <b>Unit</b>: Count
