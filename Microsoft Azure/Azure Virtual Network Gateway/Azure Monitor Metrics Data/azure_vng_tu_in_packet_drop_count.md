...
The API is used to retrieve Azure Virtual Network Gateway <b>TunnelIngressPacketDropCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of incoming packets dropped by tunnel.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TunnelIngressPacketDropCount
* <b>NetBrain Display Name</b>: Tunnel Ingress Packet Drop Count
* <b>Unit</b>: Count
