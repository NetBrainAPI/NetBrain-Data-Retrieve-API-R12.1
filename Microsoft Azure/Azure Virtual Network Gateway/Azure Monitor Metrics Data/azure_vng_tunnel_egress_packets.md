...
The API is used to retrieve Azure Virtual Network Gateway <b>TunnelEgressPackets</b> metric data from Azure API Server (https://management.azure.com/). The metric is about outgoing packet count of a tunnel.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TunnelEgressPackets
* <b>NetBrain Display Name</b>: Tunnel Egress Packets
* <b>Unit</b>: Count
