...
The API is used to retrieve Azure Virtual Network Gateway <b>UserVpnRouteCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is about count of P2S User Vpn routes learned by gateway.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: UserVpnRouteCount
* <b>NetBrain Display Name</b>: User Vpn Route Count
* <b>Unit</b>: Count
