...
The API is used to retrieve Azure Storage Account <b>Transactions</b> metric data from Azure API Server (https://management.azure.com/). The metric is about the number of requests made to a storage service or the specified API operation.
