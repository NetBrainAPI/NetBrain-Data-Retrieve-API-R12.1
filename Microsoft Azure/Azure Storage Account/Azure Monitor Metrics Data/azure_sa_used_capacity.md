...
The API is used to retrieve Azure Storage Account <b>UsedCapacity</b> metric data from Azure API Server (https://management.azure.com/). The metric is about account used capacity.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: UsedCapacity 
* <b>NetBrain Display Name</b>: Used Capacity
* <b>Unit</b>: Bytes
