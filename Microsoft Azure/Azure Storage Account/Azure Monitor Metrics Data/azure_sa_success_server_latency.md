...
The API is used to retrieve Azure Storage Account <b>SuccessServerLatency</b> metric data from Azure API Server (https://management.azure.com/). The metric is about the latency used by Azure Storage to process a successful request, in milliseconds.
