...
This API is used to retrieve the number of VMs in the instance group. Sampled every 60 seconds.

It leverages the GCP Cloud monitoring to fetch metrics of GCP resources via the GCP RESTful API. 

# Metric Info <a name="metric-info"></a>
* <b>Resource Label Used</b>: The identifier of the instance group (instance_group_id).
* <b>GCP Original Name</b>: instance_group/size
