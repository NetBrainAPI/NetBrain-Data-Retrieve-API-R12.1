...
The API is used to retrieve the queue length on the disk averaged over the last 60 seconds. For Container-Optimized OS, or Ubuntu running GKE.
...
* <b>GCP Original Name</b>: guest/disk/queue_length
