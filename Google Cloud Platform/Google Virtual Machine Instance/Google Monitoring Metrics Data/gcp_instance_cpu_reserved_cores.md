...
The API is used to retrieve the number of vCPUs reserved on the host of the instance. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: instance/cpu/reserved_cores
