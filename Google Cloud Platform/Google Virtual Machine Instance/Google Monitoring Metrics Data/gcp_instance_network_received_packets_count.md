...
This API is used to retrieve the count of packets received from the network. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: instance/network/received_packets_count
