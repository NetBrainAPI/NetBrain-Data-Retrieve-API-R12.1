...
This API is used to retrieve the amount of memory read into the guest from its own swap space. This metric is only available for VMs that belong to the e2 family.
...
* <b>GCP Original Name</b>: instance/memory/balloon/swap_in_bytes_count
