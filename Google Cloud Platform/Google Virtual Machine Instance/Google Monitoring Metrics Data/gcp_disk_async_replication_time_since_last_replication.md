...
The API is used to retrieve the seconds since the last replication was done. Also known as recovery point objective (RPO).
...
* <b>GCP Original Name</b>: disk/async_replication/time_since_last_replication
