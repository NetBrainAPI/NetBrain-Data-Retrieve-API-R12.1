...
The API is used to retrieve number of times a machine problem has happened. For Container-Optimized OS, or Ubuntu running GKE.
...
* <b>GCP Original Name</b>: guest/system/problem_count
