...
This API is used to retrieve the count of bytes read from disk. Sampled every 60 seconds. After sampling, data is not visible for up to 240 seconds.
...
* <b>GCP Original Name</b>: instance/disk/read_bytes_count
