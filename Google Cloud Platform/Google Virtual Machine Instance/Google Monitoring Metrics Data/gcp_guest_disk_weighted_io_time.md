...
The API is used to retrieve the cumulative weighted IO time spent on the disk. For Container-Optimized OS, or Ubuntu running GKE.
...
* <b>GCP Original Name</b>: guest/disk/weighted_io_time
