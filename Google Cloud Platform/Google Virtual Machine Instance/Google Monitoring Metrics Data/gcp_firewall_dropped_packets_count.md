...
This API is used to retrieve the count of incoming packets dropped by the firewall. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: firewall/dropped_packets_count
