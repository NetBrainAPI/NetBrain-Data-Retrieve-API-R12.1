...
This API is used to retrieve the disk's maximum per-second write requests over a period of time specified by the user. The period must be one minute or longer.
...
* <b>GCP Original Name</b>: instance/disk/max_write_ops_count
