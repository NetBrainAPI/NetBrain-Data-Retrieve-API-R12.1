...
This API is used to retrieve the disk's average io queue depth in the last 60s. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: instance/disk/average_io_queue_depth
