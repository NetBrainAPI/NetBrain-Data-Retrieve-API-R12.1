...
The API is used to retrieve the number of seconds that the operating system has been running for. For Container-Optimized OS, or Ubuntu running GKE. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: guest/system/uptime
