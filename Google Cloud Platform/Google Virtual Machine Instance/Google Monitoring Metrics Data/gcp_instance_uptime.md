...
This API is used to retrieve the delta of how long the VM has been running, in seconds. Note: to get the total number of seconds since VM start, use compute.googleapis.com/instance/uptime_total.
...
* <b>GCP Original Name</b>: instance/uptime
