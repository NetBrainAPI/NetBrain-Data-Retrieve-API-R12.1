...
This API is used to retrieve the count of packets sent from the network. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: instance/network/sent_packets_count
