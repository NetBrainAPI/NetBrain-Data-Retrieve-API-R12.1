...
This API is used to retrieve the total amount of memory in the VM. This metric is only available for VMs that belong to the e2 family .
...
* <b>GCP Original Name</b>: instance/memory/balloon/ram_size
