...
This API is used to retrieve the count of bytes received from the network. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: instance/network/received_bytes_count
