...
The API is used to retrieve the number of MACsec dropped egress packets on the physical link. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: network/interconnect/link/macsec/send_dropped_packets_count
