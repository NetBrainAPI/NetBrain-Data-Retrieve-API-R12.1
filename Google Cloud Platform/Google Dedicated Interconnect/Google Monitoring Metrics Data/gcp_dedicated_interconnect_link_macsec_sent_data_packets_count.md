...
The API is used to retrieve the number of MACsec egress data packets on the physical link. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: network/interconnect/link/macsec/sent_data_packets_count
