...
The API is used to retrieve operational status of MACsec (if enabled) on the physical link, Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: network/interconnect/link/macsec/operational
