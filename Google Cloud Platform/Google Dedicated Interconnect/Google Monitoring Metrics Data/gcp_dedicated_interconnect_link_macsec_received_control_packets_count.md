...
The API is used to retrieve the number of MACsec ingress control packets on the physical link. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: network/interconnect/link/macsec/received_control_packets_count
