...
The API is used to retrieve the number of inbound packets received. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: network/attachment/received_packets_count
