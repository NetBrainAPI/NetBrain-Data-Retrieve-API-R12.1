...
The API is used to retrieve the number of MACSEC ingress errors on the physical link. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: network/interconnect/link/macsec/receive_errors_count
