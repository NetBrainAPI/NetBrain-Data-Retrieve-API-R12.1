...
The API is used to retrieve the number of errors encountered while sending packets. Sampled every 60 seconds .
...
* <b>GCP Original Name</b>: network/interconnect/send_errors_count
