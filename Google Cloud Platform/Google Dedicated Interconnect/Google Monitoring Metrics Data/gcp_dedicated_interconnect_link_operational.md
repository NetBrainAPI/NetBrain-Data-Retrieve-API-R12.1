...
The API is used to retrieve whether the operational status of the circuit is 'up'. This metric is specific to individual physical circuits.
...
* <b>GCP Original Name</b>: network/interconnect/link/operational
