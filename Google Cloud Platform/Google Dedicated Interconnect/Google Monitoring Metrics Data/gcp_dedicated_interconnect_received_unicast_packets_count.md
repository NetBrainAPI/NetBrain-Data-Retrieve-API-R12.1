...
The API is used to retrieve the network interconnect received unicast packets count. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: network/interconnect/received_unicast_packets_count
