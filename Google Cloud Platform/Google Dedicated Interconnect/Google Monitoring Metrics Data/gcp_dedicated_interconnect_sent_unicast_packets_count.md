...
The API is used to retrieve the number of outbound unicast packets sent. Sampled every 60 seconds. After sampling, data is not visible for up to 180 seconds.
...
* <b>GCP Original Name</b>: network/interconnect/sent_unicast_packets_count
