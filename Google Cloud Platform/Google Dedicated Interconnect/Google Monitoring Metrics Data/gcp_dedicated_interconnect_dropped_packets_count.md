...
The API is used to retrieve the number of outbound packets dropped due to link congestion. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: network/interconnect/dropped_packets_count
