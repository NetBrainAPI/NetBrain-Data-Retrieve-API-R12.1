...
The API is used to retrieve the number of BGP sessions on the router that are down. Sampled every 60 seconds. After sampling, data is not visible for up to 180 seconds.
...
* <b>GCP Original Name</b>: bgp_sessions_down_count
