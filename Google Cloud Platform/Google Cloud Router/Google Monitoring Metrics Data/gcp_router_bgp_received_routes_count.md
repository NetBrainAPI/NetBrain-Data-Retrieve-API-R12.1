...
The API is used to retrieve the current number of routes received on a bgp session. Sampled every 60 seconds. After sampling, data is not visible for up to 180 seconds.
...
* <b>GCP Original Name</b>: bgp/received_routes_count
