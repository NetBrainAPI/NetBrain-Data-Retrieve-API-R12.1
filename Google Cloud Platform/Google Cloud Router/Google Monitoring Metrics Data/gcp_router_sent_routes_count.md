...
The API is used to retrieve the current number of routes sent by router. Sampled every 60 seconds. After sampling, data is not visible for up to 180 seconds.
...
* <b>GCP Original Name</b>: sent_routes_count
