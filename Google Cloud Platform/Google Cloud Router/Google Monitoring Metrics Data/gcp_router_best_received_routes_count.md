...
The API is used to retrieve the current number of best routes received by router. Sampled every 60 seconds. After sampling, data is not visible for up to 180 seconds.
...
* <b>GCP Original Name</b>: best_received_routes_count
