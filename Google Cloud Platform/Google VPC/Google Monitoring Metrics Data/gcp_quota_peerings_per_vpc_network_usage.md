...
The API is used to retrieve current usage on quota metric compute.googleapis.com/peerings_per_vpc_network.
...
* <b>GCP Original Name</b>: quota/peerings_per_vpc_network/usage
