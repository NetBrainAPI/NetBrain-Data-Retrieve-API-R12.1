...
The API is used to retrieve the hit count of various firewalls for network traffic. Please note that this metric applies only to firewalls for which Firewall Logging has been turned on.
...
* <b>GCP Original Name</b>: vm/all/firewall_hit_count
