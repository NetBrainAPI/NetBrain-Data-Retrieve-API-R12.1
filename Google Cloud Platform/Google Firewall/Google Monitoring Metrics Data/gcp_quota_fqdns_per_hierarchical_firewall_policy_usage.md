...
The API is used to retrieve current limit on quota metric <b>compute.googleapis.com/fqdns_per_hierarchical_firewall_policy</b> from GCP Platform. 
...
* <b>GCP Original Name</b>: quota/rule_attributes_per_global_network_firewall_policy/usage
