...
The API is used to retrieve number of attempts to exceed the limit on quota metric <b>compute.googleapis.com/rule_attributes_per_hierarchical_firewall_policy</b> from GCP Platform. 
...
* <b>GCP Original Name</b>: quota/rule_attributes_per_hierarchical_firewall_policy/exceeded
