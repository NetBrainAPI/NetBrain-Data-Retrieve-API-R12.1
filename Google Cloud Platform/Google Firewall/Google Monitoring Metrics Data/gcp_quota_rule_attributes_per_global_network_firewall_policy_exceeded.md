...
The API is used to retrieve number of attempts to exceed the limit on quota metric <b>compute.googleapis.com/rule_attributes_per_global_network_firewall_policy</b>.
