...
The API is used to retrieve current usage on quota metric <b>compute.googleapis.com/fqdns_per_regional_network_firewall_policy</b>.
...
* <b>GCP Original Name</b>: quota/fqdns_per_regional_network_firewall_policy/usage
