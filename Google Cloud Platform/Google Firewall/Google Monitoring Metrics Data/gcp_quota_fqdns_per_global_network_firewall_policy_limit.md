...
The API is used to retrieve Current limit on quota metric <b>compute.googleapis.com/fqdns_per_global_network_firewall_policy</b> from GCP Platform. 
...
* <b>GCP Original Name</b>: quota/fqdns_per_global_network_firewall_policy/limit
