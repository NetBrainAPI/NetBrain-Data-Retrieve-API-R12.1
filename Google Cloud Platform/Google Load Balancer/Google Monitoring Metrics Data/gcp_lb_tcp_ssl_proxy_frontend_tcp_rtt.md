...
The API is used to retrieve the distribution of the smoothed RTT (in ms) measured by the proxy's TCP stack, each minute application layer bytes pass from proxy to client.
...
* <b>GCP Original Name</b>: tcp_ssl_proxy/frontend_tcp_rtt
