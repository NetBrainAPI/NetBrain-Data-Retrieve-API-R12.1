...
The API is used to retrieve the number of bytes sent as responses from internal Application Load Balancer to clients. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: https/internal/response_bytes_count
