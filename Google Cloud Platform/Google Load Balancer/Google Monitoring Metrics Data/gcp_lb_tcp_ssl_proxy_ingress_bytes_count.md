...
The API is used to retrieve the number of bytes sent from client to VM using proxy. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: tcp_ssl_proxy/ingress_bytes_count
