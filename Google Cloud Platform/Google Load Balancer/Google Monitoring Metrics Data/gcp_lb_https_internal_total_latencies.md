...
The API is used to retrieve the distribution of the latency calculated from when the request was received by the internal Application Load Balancer proxy until the proxy got ACK from client on last response byte. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: https/internal/total_latencies
