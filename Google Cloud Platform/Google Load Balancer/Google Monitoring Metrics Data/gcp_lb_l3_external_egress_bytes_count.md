...
The API is used to retrieve the number of bytes sent from the backend of the external network load balancer to the client. For TCP flows, this metric counts the bytes on the application stream only.
...
* <b>GCP Original Name</b>: l3/external/egress_bytes_count
