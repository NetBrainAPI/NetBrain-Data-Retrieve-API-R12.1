...
The API is used to retrieve the number of packets sent from the internal TCP/UDP load balancer to the client.
...
* <b>GCP Original Name</b>: l3/internal/egress_packets_count
