...
The API is used to retrieve the number of connections that were created over TCP proxy or SSL proxy load balancer.
...
* <b>GCP Original Name</b>: tcp_ssl_proxy/new_connections
