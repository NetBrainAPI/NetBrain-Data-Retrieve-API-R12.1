...
The API is used to retrieve the distribution of RTT measured over TCP connections for internal TCP/UDP load balancer flows.
...
* <b>GCP Original Name</b>: l3/internal/rtt_latencies
