...
The API is used to retrieve the number of bytes sent from VM to client using proxy. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: tcp_ssl_proxy/egress_bytes_count
