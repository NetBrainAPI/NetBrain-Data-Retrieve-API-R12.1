...
The API is used to retrieve the number of packets sent from the client to the internal TCP/UDP load balancer backend.
...
* <b>GCP Original Name</b>: l3/internal/ingress_packets_count
