...
The API is used to retrieve distribution of the latency calculated from when the request was sent by the proxy to the backend until the proxy received from the backend the last byte of response.
...
* <b>GCP Original Name</b>: https/external/regional/backend_latencies
