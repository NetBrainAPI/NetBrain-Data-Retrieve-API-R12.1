...
The API is used to retrieve the number of requests served by internal Application Load Balancer. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: https/internal/request_count
