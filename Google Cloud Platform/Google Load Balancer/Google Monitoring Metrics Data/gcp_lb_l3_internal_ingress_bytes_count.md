...
The API is used to retrieve the number of bytes sent from the client to the internal TCP/UDP load balancer backend (for TCP flows it's counting bytes on application stream only).
...
* <b>GCP Original Name</b>: l3/internal/ingress_bytes_count
