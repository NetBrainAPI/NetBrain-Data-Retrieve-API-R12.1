...
The API is used to retrieve the number of bytes sent as requests from clients to HTTP/S load balancer. Sampled every 60 seconds. After sampling, data is not visible for up to 90 seconds.
...
* <b>GCP Original Name</b>: https/external/regional/request_bytes_count
