...
The API is used to retrieve the number of connections that were terminated over TCP proxy or SSL proxy load balancer.
...
* <b>GCP Original Name</b>: tcp_ssl_proxy/closed_connections
