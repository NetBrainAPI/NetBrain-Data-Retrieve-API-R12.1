...
The API is used to retrieve the distribution of the RTT measured for each connection between client and proxy. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: https/frontend_tcp_rtt
