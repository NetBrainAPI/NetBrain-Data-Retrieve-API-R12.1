...
The API is used to retrieve the number of bytes sent as responses from HTTP/S load balancer to clients. Sampled every 60 seconds. After sampling, data is not visible for up to 90 seconds.
...
* <b>GCP Original Name</b>: https/external/regional/response_bytes_count
