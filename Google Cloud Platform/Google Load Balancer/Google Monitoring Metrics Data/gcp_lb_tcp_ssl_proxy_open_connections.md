...
The API is used to retrieve the current number of outstanding connections through the TCP proxy or SSL proxy load balancer.
...
* <b>GCP Original Name</b>: tcp_ssl_proxy/open_connections
