...
The API is used to retrieve the distribution of the latency calculated from when the request was received by the proxy until the proxy got ACK from client on last response byte.
...
* <b>GCP Original Name</b>: https/total_latencies
