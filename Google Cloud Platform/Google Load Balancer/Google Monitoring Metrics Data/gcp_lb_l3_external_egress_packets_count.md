...
The API is used to retrieve the number of packets sent from the backend of the external network load balancer to the client. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: l3/external/egress_packets_count
