...
The API is used to retrieve the distribution of the round trip time latency, measured over TCP connections for the external network load balancer. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: l3/external/rtt_latencies
