...
The API is used to retrieve the number of connections that were terminated over TCP proxy or SSL proxy load balancer. Sampled every 60 seconds.
...
* <b>GCP Original Name</b>: l4_proxy/tcp/closed_connections_count
