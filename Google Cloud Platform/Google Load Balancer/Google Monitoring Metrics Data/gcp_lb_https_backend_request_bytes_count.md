...
The API is used to retrieve the number of bytes sent as requests from external HTTP(S) load balancer to backends.
...
* <b>GCP Original Name</b>: https/backend_request_bytes_count
